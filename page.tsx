        ...
        <div>
            ...
            <Section className="py-10 sm:py-14 relative overflow-hidden bg-gradient-to-b from-white via-emerald-50/30 to-white dark:from-slate-950 dark:via-emerald-950/10 dark:to-slate-950">
                ...
                <div className="relative z-10 mx-auto max-w-6xl px-4">
                  ...
                  <Image src="/service-solar-epc.jpg" alt="Solar EPC" fill className="object-cover transition-transform duration-500 group-hover:scale-105" /> */}

                            <div className="absolute inset-0 bg-gradient-to-br from-amber-400/80 to-orange-500/80" />
                  ...
                  <Image src="/service-bess.jpg" alt="BESS" fill className="object-cover transition-transform duration-500 group-hover:scale-105" /> */}

                            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/80 to-cyan-600/80" />
                  ...
                  <Image src="/service-pmc.jpg" alt="PMC" fill className="object-cover transition-transform duration-500 group-hover:scale-105" /> */}

                            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/80 to-teal-600/80" />
                  ...
                  <Image src="/service-om.jpg" alt="O&M" fill className="object-cover transition-transform duration-500 group-hover:scale-105" /> */}

                            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/80 to-indigo-600/80" />
                  ...
                  <Image src="/service-green-hydrogen.jpg" alt="Green Hydrogen" fill className="object-cover transition-transform duration-500 group-hover:scale-105" /> */}

                            <div className="absolute inset-0 bg-gradient-to-br from-green-500/80 to-lime-600/80" />
            ...
            <p className="text-[15px] text-slate-800 dark:text-slate-200 leading-7 font-medium">
